    ...
    <table className="min-w-full text-left text-sm font-light">
      ...
      <tbody>
        {paginatedProducts.map((item, index) => {
          const calculatedId = (currentPage - 1) * itemperpage + index + 1;
          return (
            <>
              <tr
              ...
              >
                <td className="whitespace-nowrap px-6 py-4">
                  <h5 className="font-medium text-black ">{calculatedId}</h5>
                </td>
                <td className="whitespace-nowrap px-6 py-4">
                ...
                <td className="whitespace-nowrap px-6 py-4">
                  <p className="text-black  font-bold">{item.productname}</p>
                </td>
                <td className="whitespace-nowrap px-6 py-4">
